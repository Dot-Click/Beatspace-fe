...
const NotificationPanel = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="absolute top-full right-0 mt-2 w-80 md:w-96 bg-[#131319] border border-[#CBC895]/30 rounded-sm shadow-2xl overflow-hidden z-[100] animate-fadeIn">
      {/* Aesthetic Accents */}
